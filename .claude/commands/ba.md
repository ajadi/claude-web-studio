...
If $ARGUMENTS provided: run business-analyst in amend mode to add the feature to tz.md.
If no $ARGUMENTS: run business-analyst in full mode to create tz.md from scratch.
